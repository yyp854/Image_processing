...
cv2.imwrite("./homework2/result/Linear_arithmeticimg/new_img1.bmp",new_img1)
...
cv2.imwrite("./homework2/result/Linear_arithmeticimg/new_img2.bmp",new_img2)
...
cv2.imwrite("./homework2/result/Linear_arithmeticimg/new_img3.bmp",new_img3)
...
cv2.imwrite("./homework2/result/Linear_arithmeticimg/new_img4.bmp",new_img4)

# #a=-1, b=255, 图像翻转
new_img5 = 255 - gray_img
cv2.imwrite("./homework2/result/Linear_arithmeticimg/new_img5.bmp",new_img5)
